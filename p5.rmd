...
GET("https://query.data.world/s/4zwqapph7shsnwskol4ljmq36ilff6", write_disk(tf <- tempfile(fileext = "data/crypto-data.xlsx")))
cd <- read_excel(tf)
```
