...
cdg <- cbind(cdg, value = cg$value)
cdg |>
  ggplot(mapping = aes(x= cdg$Date)) +
  geom_point(aes(y = cdg$value, color = "Gold"))+
...
See if the lack of variation in the price of Gold during the COVID-19 pandemic was supply-driven.
